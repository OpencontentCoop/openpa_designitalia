...
<div class="Header-utils Grid-cell">
  ...
  <div class="Header-search" id="header-search">
    <form class="Form" action="{"/content/search"|ezurl(no)}">
      <div class="Form-field Form-field--withPlaceholder Grid u-color-grey-30 u-borderRadius-s" role="search">
        {if is_area_tematica()}
          <input type="hidden" value="{is_area_tematica().node_id}" name="SubTreeArray[]"/>
          <input type="text" id="cerca" class="Form-input Grid-cell u-sizeFill u-text-r-s u-color-black u-text-r-xs u-borderRadius-s{* Form-input Grid-cell u-sizeFill u-text-r-s*}" name="SearchText"
                 {if $pagedata.is_edit}disabled="disabled"{/if}>
        ...
        <button type="submit" value="cerca" name="SearchButton" {if $pagedata.is_edit}disabled="disabled"{/if}
                class="Grid-cell u-sizeFit Icon-search Icon--rotated u-color-white u-padding-all-s u-textWeight-700{*Grid-cell u-sizeFit Icon-search u-color-white u-padding-all-s u-textWeight-700*}"

...
{*<section class="Offcanvas Offcanvas--left Offcanvas--modal js-fr-offcanvas u-jsVisibilityHidden u-nojsDisplayNone" id="menu">
    ...
    <div class="Offcanvas-content u-background-white">
        ...
        <nav>
            <ul class="Linklist Linklist--padded Treeview js-fr-treeview u-text-r-xs">
                <li><a>Assumenda tempora earum</a>
                    <ul>
                        <li><a>Sed sed esse</a></li>
                        <li><a>Nemo dicta laboriosam</a></li>
                        <li><a>Ab repudiandae optio</a>
                            <ul>
                                <li><a>Rem at odit</a></li>
                                <li><a>Rerum velit magni</a>
                                    <ul>
                                        <li><a>Rerum velit magni</a></li>
                                        <li><a>Quaerat qui nesciunt</a></li>
                                        <li><a>Dolores eligendi sit</a></li>
                                    </ul>
                                </li>
                                <li><a>Et ea vero</a></li>
                            </ul>
                        </li>
                        <li><a>Repellendus quisquam esse</a></li>
                        <li><a>Assumenda tempora earum</a></li>
                    </ul>
                </li>
                <li><a>Et ea vero</a>
                    <ul>
                        <li><a>Ab repudiandae optio</a></li>
                        <li><a>Nemo dicta laboriosam</a></li>
                        <li><a>Sed sed esse</a>
                            <ul>
                                <li><a>Quaerat qui nesciunt</a></li>

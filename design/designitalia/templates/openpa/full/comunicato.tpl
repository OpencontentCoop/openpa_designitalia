    ...
    {if $has_sidebar}
      <div class="extra">
        ...
        {if $node|has_attribute( 'geo' )}
          <h2><i class="fa fa-map-marker"></i> Luogo</h2>
          <div class="openpa-widget nav-section">
        ...
        {if $has_social}
          <h2 class="u-hiddenPrint"><i class="fa fa-share-alt" aria-hidden="true"></i> Condividi</h2>
          <div class="openpa-widget nav-section u-padding-top-xs u-hiddenPrint">

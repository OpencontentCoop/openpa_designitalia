...
<fieldset class="Form-fieldset">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="checkbox">
                <label><input type="checkbox" name="{$prefixAttribute}_ezsurvey_enabled_{$attributeID}"
                              {section show=$survey.enabled|eq(1)}checked="checked"{/section} /> {'Enabled'|i18n( 'survey' )}
                </label>
            </div>
        </div>
        <div class="col-md-4">
            <div class="checkbox">
                <label><input type="checkbox"
                              name="{$prefixAttribute}_ezsurvey_one_answer_{$attributeID}"{section show=$survey.one_answer|eq(1)} checked="checked"{/section} /> {'Only one answer allowed.'|i18n('survey')}
                </label>
            </div>
        </div>
        <div class="col-md-4">
            <div class="checkbox">
                <label><input type="checkbox"
                              name="{$prefixAttribute}_ezsurvey_persistent_{$attributeID}"{section show=$survey.persistent|eq(1)} checked="checked"{/section} /> {'Persistent user input. ( Users will be able to edit survey later. )'|i18n('survey')}
                </label>
            </div>
        </div>
    </div>
        ...
        <fieldset>
            ...
            <div class="row">
                <div class="col-md-2">
                    <div class="checkbox">
                        <label>
                            <input id="{$prefixAttribute}_ezsurvey_valid_from_no_limit_{$attributeID}" type="checkbox"
                ...
                <div class="col-md-2">
                    ...
                    <input type="hidden" name="{$prefixAttribute}_ezsurvey_valid_from_minute_hidden_{$attributeID}"
                           size="3" value="{$survey.valid_from_array.minute}"/>
                </div>
            </div>
        </fieldset>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    ...
                    <input id="{$prefixAttribute}_ezsurvey_valid_to_year_{$attributeID}"
                           name="{$prefixAttribute}_ezsurvey_valid_to_year_{$attributeID}" size="5"
                           value="{$survey.valid_to_array.year}"/>
                    <input type="hidden" name="{$prefixAttribute}_ezsurvey_valid_to_year_hidden_{$attributeID}" size="5"
                           value="{$survey.valid_to_array.year}"/>
                </div>
                <div class="col-md-2">
                    <label>{'Month'|i18n( 'survey' )}:</label>
                    <input id="{$prefixAttribute}_ezsurvey_valid_to_month_{$attributeID}"
                           name="{$prefixAttribute}_ezsurvey_valid_to_month_{$attributeID}" size="3"
                           value="{$survey.valid_to_array.month}"/>
                    <input type="hidden" name="{$prefixAttribute}_ezsurvey_valid_to_month_hidden_{$attributeID}"
                           size="3" value="{$survey.valid_to_array.month}"/>
                </div>
                <div class="col-md-2">
                    <label>{'Day'|i18n( 'survey' )}:</label>
                    <input id="{$prefixAttribute}_ezsurvey_valid_to_day_{$attributeID}"
                           name="{$prefixAttribute}_ezsurvey_valid_to_day_{$attributeID}" size="3"
                           value="{$survey.valid_to_array.day}"/>
                    <input type="hidden" name="{$prefixAttribute}_ezsurvey_valid_to_day_hidden_{$attributeID}" size="3"
                           value="{$survey.valid_to_array.day}"/>
                </div>
                <div class="col-md-2">
                    <label>{'Hour'|i18n( 'survey' )}:</label>
                    <input id="{$prefixAttribute}_ezsurvey_valid_to_hour_{$attributeID}"
                           name="{$prefixAttribute}_ezsurvey_valid_to_hour_{$attributeID}" size="3"
                           value="{$survey.valid_to_array.hour}"/>
                    <input type="hidden" name="{$prefixAttribute}_ezsurvey_valid_to_hour_hidden_{$attributeID}" size="3"
                           value="{$survey.valid_to_array.hour}"/>
                </div>
                <div class="col-md-2">
                    <label>{'Minute'|i18n( 'survey' )}:</label>
                    <input id="{$prefixAttribute}_ezsurvey_valid_to_minute_{$attributeID}"
                           name="{$prefixAttribute}_ezsurvey_valid_to_minute_{$attributeID}" size="3"
                           value="{$survey.valid_to_array.minute}"/>
                    <input type="hidden" name="{$prefixAttribute}_ezsurvey_valid_to_minute_hidden_{$attributeID}"
                           size="3" value="{$survey.valid_to_array.minute}"/>
                </div>
            </div>
        </fieldset>
    </div>
    ...
    <div class="form-group">
        ...
        <input class="form-control" name="{$prefixAttribute}_ezsurvey_redirect_submit_{$attributeID}" size="30"
            ...
            <div class="Grid u-background-grey-30 u-padding-top-s u-margin-bottom-s">
                ...
                <div class="Grid-cell u-sizeFull u-sm-size3of12 u-md-size3of12 u-lg-size3of12">
                    <div class="Form-field">
                        <div class="input-group">
                            ...
                            <input class="Form-input" type="text" size="2"
                ...
                <div class="Grid-cell u-sizeFull u-sm-size3of12 u-md-size3of12 u-lg-size3of12">
                    <div class="Form-field">
                        <label>
                            <input type="checkbox"
                                   name="{$prefixAttribute}_ezsurvey_question_visible_{$:item.id}_{$attributeID}"{section show=$:item.visible|eq(1)} checked="checked"{/section} /> {"Visible"|i18n('survey')}
                        </label>
                    </div>
                </div>
                <div class="Grid-cell u-sizeFull u-sm-size3of12 u-md-size3of12 u-lg-size3of12">

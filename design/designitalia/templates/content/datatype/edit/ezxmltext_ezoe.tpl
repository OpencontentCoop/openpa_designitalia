...
<!-- Start editor -->
    ...
    <div class="oe-window u-background-white">
        <textarea class="Form-input Form-texarea" id="{$attribute_base}_data_text_{$attribute.id}" name="{$attribute_base}_data_text_{$attribute.id}" cols="88" rows="{$editorRow}">{$input_handler.input_xml}</textarea>
    </div>

{if and( is_set( $node.data_map.fields ), $node.data_map.fields.has_content )}
    ...
    {include name=view_by_fields
    		 uri='design:datatable/view_by_fields.tpl'
             node=$node
             fields=$node.data_map.fields.content}

{else}
	{* TODO migrare a nuova versione dell'endpoint datatable *}
	...
	{undef $classeTypes $_classes $classes $class_names $fields $keys $parameters}

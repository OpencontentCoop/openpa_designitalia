...
YAHOO.ez.BlockCollapse = function(){
    ...
    var getUpdateTriggers = function() {
        var triggers = Dom.getElementsByClassName( "trigger", "select", "zone-tabs-container" );
    ...
    var exec = function() {
        ...
        for( var i = 0; i < updateTriggers.length; i++ ) {
            var triggerEl = updateTriggers[i];

            setUpdateTriggerEvent(triggerEl);
        }
    };
    ...
    var setUpdateTriggerEvent = function(o) {
        Event.purgeElement(o);
        Event.on(o, "change", triggerAction, o, true);
    };
    ...
    var updateAttributeViewMapping = function() {
        var triggers = getTriggers();
    ...
    var triggerAction = function(e, triggerEl) {
        ...
        else if ( Dom.hasClass( triggerEl, "view-select" ) ) {
            updateAttributeViewMapping();
        }

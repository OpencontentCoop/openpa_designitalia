        ...
        if ( text.val() )
        {
            ...
            $.ez( 'ezjsc::search::' + text.val(), params, function( data ){                
                ...
                {                    
                    ...
                    {
                        var html = '<li class="ezobjectrelation-search-empty-result">' + $('#ezobjectrelation-search-empty-result-text').html().replace( '--search-string--', '<em>' + data.content.SearchString + '<\/em>' ) + '<\/li>';
